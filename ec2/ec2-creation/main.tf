...
module "vpc" {
  source = "https://github.com/laura-eng-sys/jenkins-terraform-ec2.git/ec2/modules/vpc"
...
module "Ec2" {
    source = "https://github.com/laura-eng-sys/jenkins-terraform-ec2.git/ec2/modules/Ec2"   
  ec2-ami = var.ec2-ami
